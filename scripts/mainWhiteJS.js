		...
		if (mygetrequest.readyState==4){
			...
			if (mygetrequest.status==200 || window.location.href.indexOf("http")==-1){
				...
				if(d.getElementsByClassName('dashboardClientSelected')) {
					...
					elemToBeGenerated += "<div class='graph'><h2 class='graph-title'>OR</h2><span class='graph-rate or'>5</span><canvas id='chartDoughnutOR' width='165px' height='165px'></canvas><h3 class='graph-label'>Risk Rating and Profitability</h3></div>";
					elemToBeGenerated += "<div class='graph'><h2 class='graph-title'>RW</h2><span class='graph-rate'>45%</span><canvas id='chartDoughnutRW' width='165px' height='165px'></canvas><h3 class='graph-label'>Risk Weight</h3></div>";
					...
					//elemToBeGenerated += "<div class='tableRow'><span class='creditRequestL'>Reception Date</span><span class='creditRequestR'>"+new Date(myObject.receptionDate)+"</span></div>";
						...
						//elemToBeGenerated += "<div class='tableRow'><span class='creditRequestL'>Guarantors</span><span class='creditRequestR'>"+myObject.details.guarantors + "</span></div>";
							...
							elemToBeGenerated += "<div class='tableFinanceHead'><div id='financeHead1'>Dept Facilities</div><div class='financeHead' id='financeHead2'>Tranche</div><div class='financeHead' id='financeHead3'>Total(€M)</div><div class='financeHead' id='financeHead4'>SG</div><div class='financeHead' id='financeHead5'>Pricing</div><div class='financeHead' id='financeHead6'>Repayment</div><div class='financeHead' id='financeHead7'>Maturity</div><div class='clear'></div></div>";
							elemToBeGenerated += "<div class='tableFinanceRow'><div id='financeRow1'></div><div class='financeRow' id='financeRow2'>"+myObject.details.facilities[0].tranche+"</div><div class='financeRow' id='financeRow3'>"+myObject.details.facilities[0].total +"<span class='cRCurrency'>" + myObject.details.currency.toLowerCase() +"</span></div><div class='financeRow' id='financeRow4'>"+myObject.details.facilities[0].sg + " <span class='cRCurrency'>" + myObject.details.currency.toLowerCase() +"</span></div><div class='financeRow' id='financeRow5'>"+myObject.details.facilities[0].pricing + "</div><div class='financeRow' id='financeRow6'>"+myObject.details.facilities[0].repayment + "</div><div class='financeRow' id='financeRow7'>"+myObject.details.facilities[0].maturity +"</div><div class='clear'></div></div>";
							elemToBeGenerated += "<div style='height:60px;'></div>";
						...
						//elemToBeGenerated += "<div class='tableRow'><span class='creditRequestL'>Categorization</span><span class='creditRequestR'>"+myObject.details.categorization+"</span></div>";
							...
							elemToBeGenerated += "<div class='riskRow' id='riskRow1'>OR</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow2'>PD</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow3'>LGD</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow4'>RW</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow5'>EL bppa</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow6'>REVA</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow7'>RARORC</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow8'>RARORC after LCR</div>";
							elemToBeGenerated += "<div class='riskRow' id='riskRow9'>Return on funding</div>";
							elemToBeGenerated += "<div class='clear'></div></div>";
